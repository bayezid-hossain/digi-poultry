...
CREATE INDEX IF NOT EXISTS "post_user_idx" ON "dp_company_record" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "post_created_at_idx" ON "dp_company_record" USING btree ("created_at");--> statement-breakpoint
